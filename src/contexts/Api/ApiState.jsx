...
import { accountsBackendUrl, eventsBackendUrl } from "../../utils/urls";

export default function ApiState({ children }) {
  const accBaseUrl = accountsBackendUrl;
  const eventsBaseUrl = eventsBackendUrl;
